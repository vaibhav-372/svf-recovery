...
const Home = () => {
  ...
  <View style={tw`flex-row items-center`}>
    ...
    <Text style={tw`ml-1 text-base font-semibold text-gray-800`}>Hi Vaibhav</Text>
    <Ionicons name="chevron-down-outline" size={16} color="#4B5563" style={tw`ml-1`} />
    </View>
    ...
    <View style={tw`flex-row items-center`}>
      ...
      <View style={tw`flex-row justify-around mt-10 px-4`}>
        ...
        <View style={tw`items-center`}>
          <Progress.Circle
            ...
            textStyle={{ fontWeight: 'bold', color: '#1F2937' }}
            />
          <Text style={tw`mt-2 text-gray-600 text-base font-bold`}>Avg travel/day: {travel.toFixed(1)}</Text>
        </View>
      </View>
